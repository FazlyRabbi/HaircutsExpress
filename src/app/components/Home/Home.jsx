    ...
    <section className="  relative">
            ...
            <section>
              <div className="bg-[#F5EEE7] w-full py-10">
                <div className="container mx-auto px-4">
                  ...
                  >
                    <div className="bg-white text-center w-full py-10 custom__shadow  text-[#14100C] hover:text-[#91765A] transition-all duration-300">
      ...
      {/* <section className="py-[20rem]">
        <div className="  text-center container mx-auto">
          ...
          <div>
            <div className="mt-5  border border-[#f4e8e1] p-8    rounded-[50px]">
